    ...
    return (
        <>
            <form className="w-4/5 flex" onSubmit={onCreateShorlink}>
                <input onChange={ (e) => setURL(e.target.value)} className="my-8 p-2 text-xl font-bold w-4/5 focus:outline-none focus:ring focus:border-blue-300" type="text" placeholder="https://example.com" value={URL}/>
