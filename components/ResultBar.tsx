...
export default function ResultBar() {
    ...
    return (
        ...
        <div className="w-full flex flex-col md:flex-row">
                <input readOnly className="mt-8 md:my-8 p-2 text-xl text-gray-800 font-bold md:w-4/5 focus:outline-none focus:ring focus:border-blue-300" type="text" placeholder="https://example.com" value={process.env.NEXT_PUBLIC_BASE_URL +"/"+shortlink[shortlink.length-1].path}/>
