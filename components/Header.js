...
const Header = () => {
  return (
    <>
      <div className="flex md:justify-between items-center border-b-2 border-gray-100 py-6 sm:justify-start md:space-x-3">
